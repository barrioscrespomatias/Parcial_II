    ...
    if(this!= NULL && pFunc != NULL && (order == 0 || order == 1))
    {
        for(i=0; i<ll_len(this)-1; i++)
        {
            ...
            for(j=i+1; j<ll_len(this); j++)
            {
                ...
                else if(pFunc(pPrimero,pSegundo)>0)
                {
                    pAuxiliar = pPrimero;
                    pPrimero = pSegundo;
                    pSegundo = pAuxiliar;
...
//    {
//        empleado = (Employee*)p;
//        if(empleado->horasTrabajadas>0 && empleado->horasTrabajadas<177 )
//        {
//            retorno = 1;
//        }
//
//        if(empleado->horasTrabajadas>176 && empleado->horasTrabajadas<209 )
//        {
//            retorno = 2;
////            empleado->sueldo = empleado->horasTrabajadas*270;
//        }
//
//        if(empleado->horasTrabajadas>208 && empleado->horasTrabajadas<241 )
//        {
//            retorno = 3;
////            empleado->sueldo = empleado->horasTrabajadas*360;
//        }
//    }
//    return retorno;
//}
...
int al_map(LinkedList* this, int employee_filterByHoras, int criterio)
//int (*pFunc)(void*,void*)
{
    int returnAux = -1;
    int i;
    ...
    if(this!= NULL && employee_filterByHoras!= NULL)
    {
        for(i=0; i<ll_len(this); i++)
        {
            if(employee_filterByHoras == 1)
            {
                sueldo = empleado->horasTrabajadas*180;
                employee_setSueldo(this,sueldo);
            }

            if(employee_filterByHoras == 2)
            {
                sueldo = empleado->horasTrabajadas*270;
                employee_setSueldo(this,sueldo);
            }

            if(employee_filterByHoras == 3)
            {
                sueldo = empleado->horasTrabajadas*360;
                employee_setSueldo(this,sueldo);
            }
